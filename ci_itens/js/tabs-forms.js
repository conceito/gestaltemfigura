$(document).ready(function() {
	...
	*/
    ...
    $('#galeria .crop').hover(function() {
        $('.controle', this).animate({top: 0}, 'fast');
    }, function() {
        $('.controle', this).animate({top: 90}, 'fast');
    });
    ...
    $('.bot-verde', '#super-alerta').click(function() {
        ...
        $('#super-alerta').animate({top: '-80px'}, 'slow', 'swing', function() {
            $('#super-alerta').hide();
        }); // retira alerta
...
function retiraNosTbl(ids) {
    for (x = 0; x < ids.length; x++) {
        if ($.browser.msie)
            $('tr[id=' + ids[x] + ']').empty().css({height: '40px'});
        else
            $('tr[id=' + ids[x] + ']').animate({opacity: 0}, 'slow', 'linear', function() {
                $('tr[id=' + ids[x] + ']').empty().css({height: '40px'});
            });
    }
}
