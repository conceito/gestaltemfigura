...
?>
      ...
      <?php if($listOptions['sortable']) echo '<td valign="top" class="dragme"></td>'?>
        ...
        <td valign="top"><a href="<?php echo $edicao;?>" title="Ver arquivos desta pasta"><img src="<?php echo $baseurl;?>ci_itens/img/pasta-<?php echo $row['termo'];?>.png" width="32" height="30" alt="<?php echo $row['termo'];?>" /></a></td>
