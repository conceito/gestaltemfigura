        ...
        <div id="add-page" class="box-menu-ajax">
            ...
            <div class="box-menu-tabs">
                ...
                <div id="tab-paginas">
                  ...
                  <img src="<?php echo $bs;?>ci_itens/img/loader.gif" width="43" height="43" alt="loading" class="loading" style="float:left;" />
                ...
                <div id="tab-pesquisar">
                    ...
                    <img src="<?php echo $bs;?>ci_itens/img/loading.gif" width="16" height="16" alt="loading" class="loading" />
