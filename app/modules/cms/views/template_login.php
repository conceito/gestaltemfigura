...
<link rel="stylesheet" href="<?php echo $baseurl;?>ci_itens/css/estilo-cms4.css" />
<link rel="stylesheet" href="<?php echo $baseurl;?>ci_itens/css/estilo-cms-cliente.css" />
...
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/jquery-1.8.0.min.js"></script><!-- 1-->
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/jquery.validate.js"></script>
<script type="text/javascript" src="<?php echo $baseurl;?>ci_itens/js/login.js"></script>
...
body{
	background:#CCC url(<?php echo $baseurl;?>ci_itens/img/login-bg.jpg) no-repeat center center;
...
<body scroll="no"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <input name="" type="image" src="<?php echo $baseurl;?>ci_itens/img/login-bot1.png" alt="OK" class="bot-ok" />
    </form>
