...
<label for="chave" class="lb-full">Logo</label>
...
<label for="chave" class="lb-full">Chave geral</label><div class="form-opcoes">
...
<label class="lb-full">&nbsp;</label><div class="form-opcoes">
...
<label for="upload" class="lb-full">Tipo de Upload</label><div class="form-opcoes">
...
<label for="comment_message" class="lb-full">Receber notificação de novos comentários</label><div class="form-opcoes">
