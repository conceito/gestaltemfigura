...
<fieldset><legend><?php echo $campo;?> (<?php echo strtoupper($type);?>)</legend>
    ...
    <label for="extraCampo_<?php echo $name;?>" class="lb-full">Nome do campo</label><input name="extraCampo_<?php echo $name;?>" id="extraCampo_<?php echo $name;?>" type="text" class="input-longo input-titulo" value="<?php echo set_value('extraCampo_'.$name, $campo);?>" />
    
    <br />

    
    <label for="extraId_<?php echo $name;?>" class="lb-full">Identificador</label><input name="extraId_<?php echo $name;?>" id="extraId_<?php echo $name;?>" type="text" class="input-longo" value="<?php echo set_value('extraId_'.$name, $name);?>" />
	...
	echo '<label for="" class="lb-full"><strong>Opções / classe:</strong></label>
   ...
   <br /><br />';
    ...
    <label for="<?php echo $lbform;?>" class="lb-full">#<?php echo $x + 1;?></label><input name="<?php echo $lbform;?>" id="<?php echo $lbform;?>" type="text" class="input-longo" value="<?php echo set_value('$lbform', $op);?>" />
...
<label for="extraCampo_novo" class="lb-full">Nome do campo</label><input name="extraCampo_novo" id="extraCampo_novo" type="text" class="input-longo input-titulo" value="" />
    
    <br />

    
    <label for="extraId_novo" class="lb-full">Identificador</label><input name="extraId_novo" id="extraId_novo" type="text" class="input-longo" value="" />
    
<br />
<br />

    
    <label for="tipo" class="lb-full">Tipo</label><div class="form-opcoes">
...
<label for="" class="lb-full"><strong>Opções:</strong></label>
...
<label for="extraOp_novo_0" class="lb-full">#1</label><input name="extraOp_novo_0" id="extraOp_novo_0" type="text" class="input-longo" value="" />

<br />

<label for="extraOp_novo_1" class="lb-full">#2</label><input name="extraOp_novo_1" id="extraOp_novo_1" type="text" class="input-longo" value="" />
