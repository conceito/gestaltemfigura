...
<label for="tipo" class="lb-full">Tipo de admin</label>
...
<div <?php echo ($row['tipo']==2)?'':'style="display:none;"';?> class="div-modulos"><label for="modulos" class="lb-full">Módulos</label>
<?php echo $comboModulos;?><?php echo i('Escolha os Módulos que o administrador terá acesso.');?></div>

<br />

<label for="acoes" class="lb-full">Ações permitidas</label>
<div class="form-opcoes">
