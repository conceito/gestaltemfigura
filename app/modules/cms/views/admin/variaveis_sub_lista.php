...
<label for="titulo_<?php echo $id;?>" class="lb-full">Opção #<?php echo $i;?></label><input name="titulo_<?php echo $id;?>" id="titulo_<?php echo $id;?>" type="text" class="input-longo input-titulo" value="<?php echo set_value('titulo_'.$id, $label);?>" />
