<?php
$baseurl = base_url();
$imgcms = $baseurl.'ci_itens/img';
$path = $baseurl.'upl/arqs';
...
<div class="gallery-top-bar">
	...
	<?php 
		if(!$galery){
			echo '<div class="como-editar-img" align="center" style="clear:both;"><img src="'.$baseurl.'ci_itens/img/como_editar_arq.jpg" width="676" height="214" alt="como editar arquivos" /></div>';	
		}
