...
<?php
		if(!$galery){
			echo '<div class="como-editar-img" align="center" style="clear:both;"><img src="'.$baseurl.'ci_itens/img/como_editar_img.jpg" width="621" height="214" alt="como editar imagens" /></div>';
		}
