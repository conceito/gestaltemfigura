...
<div id="tabs">
    ...
    ?>
    <li><a href="#tabs-<?php echo $nt;?>"><?php echo $t?></a><img src="<?php echo $baseurl;?>ci_itens/img/ico-salvar.gif" width="8" height="8" alt="atualizado!" title="Não esqueça de salvar!" class="ico-atualizar" /></li>
    <?php
		$nt++;
	endforeach;
	?>
