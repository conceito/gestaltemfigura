...
?>
 <!--barra de navegação básica-->
      ...
      por página | -->
      <form action="<?php echo cms_url(uri_string());?>" method="post" name="busca" class="form-busca"><input name="q" value="<?php echo $b;?>" type="text" class="input-busca" /><input name="" type="image" src="<?php echo $baseurl;?>ci_itens/img/bot-form-ok.gif" alt="ok" class="ok" />                                                       
      ...
      <div class="perciana">
      <a href="#" class="fechar-filtros"><img src="<?php echo $baseurl;?>ci_itens/img/bot-fecha-div.gif" width="12" height="11" alt="fechar" /></a>
     ...
     &nbsp;&nbsp;&nbsp;
      <label><?php echo form_radio('ativo', 1, $ativos);?> ativos</label>
       ...
       <input name="" type="image" src="<?php echo $baseurl;?>ci_itens/img/bot-form-pesquisar.gif" alt="pesquisar" class="bot-pesquisar" />
      ...
      <div class="perciana">
       ...
       <input name="" type="image" src="<?php echo $baseurl;?>ci_itens/img/bot-exportar.gif" alt="pesquisar" class="bot-pesquisar" />
