...
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/jquery-1.7.1.min.js"></script><!-- 1-->
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/jquery.delay.js"></script><!-- 2-->
<script type="text/javascript" src="<?php echo $baseurl;?>ci_itens/js/funcoes-cms.js"></script><!-- 2-->
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/jquery.qtips.js"></script><!-- 3-->
<script type="text/javascript" src="<?php echo $baseurl;?>libs/jquery/ui.core.182.js"></script><!-- 4-->
<?php
if(isset($scripts))echo $scripts;
?>
<script type="text/javascript" src="<?php echo $baseurl;?>ci_itens/js/padrao-cms.js"></script>
<?php
if(isset($estilos))echo $estilos;
?>
<link rel="stylesheet" href="<?php echo $baseurl;?>ci_itens/css/groundwork.css" />
<link href="<?php echo $baseurl;?>ci_itens/css/ui/jquery-ui-1.8.23.custom.css" rel="stylesheet" type="text/css" media="screen" />


<link href="<?php echo $baseurl;?>ci_itens/css/estilo-cms4.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo $baseurl;?>ci_itens/css/estilo-cms-cliente.css" rel="stylesheet" type="text/css" media="all" />
<!--padrão CMS fim-->
