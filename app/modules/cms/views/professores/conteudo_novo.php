...
<div class="panel-left clearfix">
	...
	<div class="ai-page">
        ...
        <div class="page">
        <label for="titulo" class="lb-full"><b class="obr">[!]</b> Nome</label><input name="titulo" id="titulo" type="text" class="input-longo input-titulo" value="<?php echo set_value('titulo');?>" />
        </div>
