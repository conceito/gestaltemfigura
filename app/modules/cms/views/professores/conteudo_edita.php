...
<div class="panel-left clearfix">
    ...
    <div class="ai-page">
        ...
        <div class="page">
        <label for="titulo" class="lb-full">Nome</label><input name="titulo" id="titulo" type="text" class="input-longo input-titulo" value="<?php echo set_value('titulo', form_prep($row['titulo']));?>" />
        </div>
...
<div class="panel-right clearfix">
	...
	<label for="tags" class="lb-full">CRP</label>
