...
<div class="img-infos">
  <img src="<?php echo $bu;?>upl/imgs/<?php echo thumb($arq['nome']);?>" alt="img" />
...
<ul class="lista-opcoes-giro">
	<li><a href="<?php echo cms_url('cms/imagem/girar/op:270/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/giro-90d.jpg" width="36" height="43" alt="90 direita" />90º para<br />direita</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/girar/op:180/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/giro-180.jpg" width="36" height="43" alt="180" />180º</a></li>
	<li style="width:100px;"><a href="<?php echo cms_url('cms/imagem/girar/op:90/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/giro-90e.jpg" width="33" height="43" alt="90 esquerda" />90º para<br />esquerda</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/girar/op:hor/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/giro-h.jpg" width="33" height="43" alt="inverter" />Inverter na<br />horizontal</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/girar/op:vrt/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/giro-v.jpg" width="33" height="43" alt="inverter" />Inverter na<br />vertical</a></li>
</ul>
<h4>Cortar</h4>
<ul class="lista-opcoes-corte">
	<li style="width:90px;"><a href="<?php echo cms_url('cms/imagem/crop/op:livre/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/corte-livre.jpg" width="38" height="42" alt="90 direita" />corte<br />livre</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/crop/op:quadrado/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/corte-quadrado.jpg" width="40" height="42" alt="180" />corte<br />quadrado</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/crop/op:43/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/corte-h.jpg" width="41" height="42" alt="90 esquerda" />retângulo<br />deitado 4:3</a></li>
	<li><a href="<?php echo cms_url('cms/imagem/crop/op:34/id:'.$id);?>"><img src="<?php echo $bu;?>ci_itens/img/corte-v.jpg" width="38" height="42" alt="inverter" />retângulo<br />em pé 3:4</a></li>
