...
<a href="<?php echo $linkRetorno;?>"><img src="<?php echo $bu?>ci_itens/img/bot-cancelar.jpg" width="91" height="22" alt="cancelar" /></a>
<input name="" type="image" src="<?php echo $bu?>ci_itens/img/bot-cortar.jpg" alt="cortar" />
</div>
