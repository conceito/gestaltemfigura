...
<input name="submit" type="image" src="<?=base_url()?>ci_itens/img/bot-salvar.jpg" alt="salvar" id="btnSubmit-depreciado" style="clear:both; margin-top:15px; display:none;" />
