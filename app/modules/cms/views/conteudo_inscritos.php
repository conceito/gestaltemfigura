...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbl_tab">
	  ...
	  if(! $inscritos):
		...
		<strong class="fs-11"><a href="<?php echo cms_url('cms/usuarios/dadosUser/id:'.$user_id);?>" title="Editar este item" class="nyroModal" target="_blank"><?php echo $nome;?></a></strong>
        	<div class="opcoes">
      ...
      <tr class="<?php echo $zebra;?>" id="comment-<?php echo $id;?>">      	
        <td colspan="6" valign="top"><div class="comment-div cd-<?php echo $id;?>"><textarea name="comment-<?php echo $id;?>" cols="" rows=""><?php echo $ins['comentario'];?></textarea></div></td>
      </tr>
