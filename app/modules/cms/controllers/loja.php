...
//        mybug($this->dados['options_estoque'], true);
    ...
    function vendas($_var = '') {
         ...
         */
        $this->botoes = array('check' => '', 'apagar' => '#',            
            'imprimir' => 'cms/loja/faturaPrint/co:' . $this->var['co']);
        $navegaOff = array();
...
//        mybug($this->dados['extr'], true);
    ...
    public function imprimir_fatura(){
        ...
        $conteudo = $this->loja->get_full_extrato($vars['extrato']);
        
        $view['f'] = $conteudo;
        $view['loja'] = $this->loja->get_configuracoes();
        
        $this->load->view('cms/loja/fatura', $view);
